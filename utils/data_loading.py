    ...
    def __init__(self,
        ...
        with Pool(1) as p:
            unique = list(tqdm(
                ...
                total=len(self.ids),
                desc=f"Scanning {src_domain_name}",
                leave=True
            ))
...
class CarvanaDataset(BasicDataset):
    def __init__(self, images_dir, mask_dir, src_domain_name, scale=1):
        super().__init__(images_dir, mask_dir, scale=scale, mask_suffix='_mask', src_domain_name=src_domain_name)
